$(function () {
  ...
  $('#cloud-box').click(function () {
    location.href = 'https://esc.buy.cloud.antx.cc/'
  })
  $('#domain-box').click(function () {
    location.href = 'https://domain.buy.cloud.antx.cc/'
  })
  $('#recomment-box').click(function () {
    location.href = 'https://home.console.cloud.antx.cc/'
  })
  $('#logon-box').click(function () {
    location.href = 'https://passport.cloud.antx.cc/register'
  })
  $('#cps-box').click(function () {
    location.href = 'https://cps.buy.cloud.antx.cc/'
  })
})